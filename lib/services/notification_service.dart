...
class NotificationService {
  ...
  String? _currentRoleValue() {
    final user = _authService.currentUser;
    if (user != null) {
      return _roleToTargetRole(user.role);
    }

    final remoteUser = _client?.auth.currentUser;
    final rawRole = remoteUser?.userMetadata?['role']?.toString().toLowerCase();
  ...
  String? _roleToTargetRole(UserRole role) {
    return switch (role) {
